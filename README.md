...
面向中小跨境电商卖家的非遗包装 AI 设计平台概念原型。通过“一张产品图—目标市场选择—非遗元素匹配—完整方案输出”的流程，展示包装视觉、文化文案、标签提示与 3D 预览的一体化能力。

## 在线体验

- GitHub Pages：https://wsylnbgw789.github.io/wenmai/
- 项目展示：https://wenmai-ai-design.juniorquinter-omjrja.chatgpt.site
